...
<div style="clear:both;">
    ...
    <div class="inputs five columns omega">
        <input name="x3d_delete" type="checkbox" value="1">&nbsp;
        <?php echo ('Dateien und Datenbankeintrag für das Objekt werden entfernt.'); ?>
    </div>
</div>
<?php endif; ?>
<div style="clear:both;">
        ...
        <div class="x3d-drawer-contents">
            ...
            <div class="field two columns alpha" id="x3d-file-inputs">
                <label><?php echo __('3D Datei auswählen (.x3d)'); ?></label>
            </div>
