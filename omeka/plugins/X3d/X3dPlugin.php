...
class X3dPlugin extends Omeka_Plugin_AbstractPlugin
{
     ...
     * Add JS to footer
     */
    // public function hookAdminFooter($view)
    // {
    //     echo common('x3d-footer', array(
    ...
    public function hookPublicContentTop($args)
    {
        ...
        // if (!array_key_exists('item', $args) && !array_key_exists('mapItem', $args)) {
        //     return;
        // }
        // if (array_key_exists('item', $args) && !array_key_exists('mapItem', $args)) {
        //     $item = $args['item'];
        ...
        //     $height = get_option('geolocation_item_map_height') ? get_option('geolocation_item_map_height') : '300px';
        //     $html = "<div id='geolocation'>";
        //     $html .= $view->itemGoogleMap($item, $width, $height, true);
        //     $html .= "</div>";
        //     echo $html;
        // }
    }
...
//         }
    ...
    public function hookInitialize()
    {
        ...
        // $this->itemTypeId{'Ort'} = $itemTypesTable->findByName('Ort')->id;
        // $this->itemTypeId{'Medienobjekt BGG'} = $itemTypesTable->findByName('Medienobjekt BGG')->id;
        // $this->itemTypeId{'Geschichte BGG'} = $itemTypesTable->findByName('Geschichte BGG')->id;
    }
    ...
    public function filterAdminItemsFormTabs($tabs, $args)
    {
        ...
        // var_dump($item);
        // echo '</pre>';
        // if ($item->item_type_id == $this->itemTypeId{'Ort'} ||
        //     (isset($_GET['type_id']) && $_GET['type_id'] == $this->itemTypeId{'Ort'})) {
