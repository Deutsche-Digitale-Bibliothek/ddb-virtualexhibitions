...
function ddb_exhibit_builder_attachment_markup($attachment) {
    return ExhibitDdbHelper::getAttachmentMarkup($attachment);
}
...
function exhibit_builder_attachment_markup($attachment, $fileOptions, $linkProperties, $thumbnail = null)
{
    ...
    // $foo = file_markup('http://www.deutsche-digitale-bibliothek.de/binary/QLYY5KVRW64Y6ZXWBYWEGTTRVJGBIXHQ/mvpr/1.jpg', $fileOptions, null);
    // var_dump($file, $attachment, $fileOptions, $linkProperties, $thumbnail, $foo);
