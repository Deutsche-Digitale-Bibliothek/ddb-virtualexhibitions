<?php $titlelogopos = metadata('exhibit', 'titlelogopos'); ?>
<div class="container-fluid titlelogo-partial">
    <div class="row">
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div class="titlelogo-container titlelogo-<?php echo $titlelogopos; ?>">
                <img src="<?php echo WEB_FILES . '/layout/titlelogo/' . $titlelogo; ?>" alt="title" class="titlelogo">
            </div>
        </div>
    </div>
</div>
