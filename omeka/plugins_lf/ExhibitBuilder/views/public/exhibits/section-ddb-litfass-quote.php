...
<<?php echo $sectionTag; ?>
    ...
    class="<?php echo ($inSlider)? 'slide' : 'section'; ?> section-cite <?php echo $colors[$exhibitSection->backgroundcolor]['type']; ?> tile"
                        ...
                        <div class="scroll-frame">
                            <div class="scroll-element">
                                ...
                                <div class="quote-container">
                                    ...
                                    <h4><i><?php echo __('Bitte Zitat eingeben'); ?> ...</i></h4>
                                    <?php else: ?>
                                    <?php echo $blockquote; ?>
                                    <?php endif; ?>
                                    </blockquote>
                                    <cite>
                                        <?php $cite = exhibit_builder_page_text(2); ?>
                                        <?php if (empty($cite)): ?>
                                        <h4><i><?php echo __('Bitte Quelle eingeben'); ?> ...</i></h4>
                                        <?php else: ?>
                                        <?php echo $cite; ?>
                                        <?php endif; ?>
                                    </cite>
