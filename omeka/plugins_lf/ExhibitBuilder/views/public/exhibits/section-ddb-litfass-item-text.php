...
<<?php echo $sectionTag; ?>
    ...
    class="<?php echo ($inSlider)? 'slide' : 'section'; ?> section-text-media <?php echo ($pageoptions['align'] === 'left')? 'section-text-media-left' : 'section-text-media-right'; ?> <?php echo $colors[$exhibitSection->backgroundcolor]['type']; ?> tile"
            ...
            <div class="col-md-6 col-media<?php echo ($pageoptions['align'] === 'left')? ' order-md-last' : ''; ?>">
                <div class="container-media">
                    <div class="content-controls<?php echo ($pageoptions['align'] === 'left')? ' order-md-last' : ''; ?>">
                        ...
                        <div class="control-zoom<?php echo (ExhibitDdbHelper::isX3d($attachment)) ? ' control_e-x3d' : ' control_e-zoom'; ?> control-icon<?php echo ($pageoptions['align'] === 'left')? ' control-icon-right' : ' control-icon-left'; ?>">
                        ...
                        <?php endif; ?>
                        <div class="meta-scroll-controls d-none<?php echo ($pageoptions['align'] === 'right')? ' meta-scroll-controls-left' : ''; ?>">
